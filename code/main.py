...
if __name__ == '__main__':
    ...
    game = GameOptimizer(opt_algo=GN_MLSL, opt_algo_2=LN_COBYLA, game_location=game_location, logs_location=logs_location, ingame_instance_count=25, timeout=30)
    ...
    game.optimize(xtol_rel=0.1, ftol_rel=0.1, maxeval=10)
    game.plot_data()
    game.store_data()